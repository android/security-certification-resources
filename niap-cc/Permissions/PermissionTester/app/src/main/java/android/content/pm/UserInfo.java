...
public class UserInfo implements Parcelable {
    ...
    public UserInfo(int id, String name, String iconPath, int flags) {
        ...
        this.profileGroupId =0;// NO_PROFILE_GROUP_ID;
        this.restrictedProfileParentId = 0;//NO_PROFILE_GROUP_ID;
    }
    ...
    public UserHandle getUserHandle() {
        ...
        return UserHandle.getUserHandleForUid(id);
        //return new UserHandl
    }
    @Override
