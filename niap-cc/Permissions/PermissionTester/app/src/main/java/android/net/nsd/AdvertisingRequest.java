...
public final class AdvertisingRequest implements Parcelable {
     ...
     */
    private AdvertisingRequest( NsdServiceInfo serviceInfo, int protocolType,
                               long advertisingConfig,  Duration ttl) {
...
//    @FlaggedApi(NsdManager.Flags.ADVERTISE_REQUEST_API)
    ...
    public static final class Builder {
         ...
         */
        public Builder( NsdServiceInfo serviceInfo, int protocolType) {
            mServiceInfo = serviceInfo;
            mProtocolType = protocolType;
        }
