...
public class LaunchIntentUtil {
    ...
    /**
     * @returns true if TestDPC was launched as part of a COSU deployment. This is identified by a
     *     cosu extra in the admin extras.
     */
    ...
    /**
     * @returns the account name in the given bundle, as populated by {@link
     *     #prepareDeviceAdminExtras(Intent, PersistableBundle)}
     */
    public static String getAddedAccountName(PersistableBundle persistableBundle) {
        return persistableBundle != null ? persistableBundle.getString(EXTRA_ACCOUNT_NAME, null) : null;
    }
