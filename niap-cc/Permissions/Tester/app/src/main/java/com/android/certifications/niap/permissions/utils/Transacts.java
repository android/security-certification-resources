...
public class Transacts {
    ...
    private static class S2Transacts extends Transacts {
        public S2Transacts() {
            mDeviceApiLevel = 32;
            Map<String, Integer> transactIds;
            ...
            transactIds = new HashMap<>();
            transactIds.put(dismissKeyguard, 50);
            mDescriptorTransacts.put(ACTIVITY_CLIENT_DESCRIPTOR, transactIds);
            ...
            transactIds = new HashMap<>();
            transactIds.put(resetAppErrors, 214);
            transactIds.put(bindBackupAgent, 82);
            transactIds.put(performIdleMaintenance, 156);
            transactIds.put(setDumpHeapDebugLimit, 173);
            transactIds.put(updateLockTaskPackages, 175);
            ...
            transactIds.put(setHasTopUi, 194);
            ...
            transactIds.put(resumeAppSwitches, 81);
            transactIds.put(getContentProviderExternal, 118);
            transactIds.put(getIntentForIntentSender, 146);
            ...
            transactIds.put(setAlwaysFinish, 36);
            transactIds.put(startActivityFromRecents, 163);
            ...
            transactIds.put(requestBugReport, 136);
            ...
            transactIds.put(signalPersistentProcesses, 52);
            transactIds.put(updateConfiguration, 41);
            transactIds.put(appNotRespondingViaProvider, 157);
            transactIds.put(shutdown, 79);
            mDescriptorTransacts.put(ACTIVITY_DESCRIPTOR, transactIds);
            ...
            transactIds = new HashMap<>();
            transactIds.put(setRefreshRateSwitchingType, 43);
            transactIds.put(setTemporaryAutoBrightnessAdjustment, 37);
            transactIds.put(startWifiDisplayScan, 6);
            transactIds.put(shouldAlwaysRespectAppRequestedMode, 42);
            transactIds.put(requestColorMode, 19);
            mDescriptorTransacts.put(DISPLAY_DESCRIPTOR, transactIds);
            ...
            transactIds = new HashMap<>();
            transactIds.put(createInputConsumer, 82);
            transactIds.put(setAnimationScale, 37);
            ...
            transactIds.put(removeWindowToken, 18);
            transactIds.put(thawRotation, 50);
            transactIds.put(registerShortcutKey, 81);
            transactIds.put(clearWindowContentFrameStats, 73);
            transactIds.put(overridePendingAppTransitionRemote, 23);
            transactIds.put(setRecentsVisibility, 65);
            transactIds.put(stopFreezingScreen, 26);
            transactIds.put(dismissKeyguard, 32);
            transactIds.put(screenshotWallpaper, 57);
            mDescriptorTransacts.put(WINDOW_DESCRIPTOR, transactIds);
            ...
            transactIds.put(installCaCert, 98);
            transactIds.put(getNearbyNotificationStreamingPolicy, 57);
            transactIds.put(markProfileOwnerOnOrganizationOwnedDevice, 304);
            transactIds.put(forceSecurityLogs, 258);
            transactIds.put(getDoNotAskCredentialsOnBoot, 217);
            transactIds.put(clearSystemUpdatePolicyFreezePeriodRecord, 214);
            transactIds.put(setDeviceOwner, 77);
            mDescriptorTransacts.put(DEVICE_POLICY_DESCRIPTOR, transactIds);
