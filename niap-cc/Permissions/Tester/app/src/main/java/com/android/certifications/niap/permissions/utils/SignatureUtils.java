...
public class SignatureUtils {
    ...
    public static Signature getAppSigningCertificate(Context context, String packageName) {
        try {
            ...
            StatusLogger.logError("No signatures returned from getApkContentsSigners");
            return null;
        } catch (PackageManager.NameNotFoundException e) {
            StatusLogger.logError("Caught a NameNotFoundException querying PackageInfo for package "
                    + packageName, e);
            return null;
        }
    }
