...
public interface IMigrationCallback extends android.os.IInterface
{
    ...
    public static class Default implements android.health.connect.aidl.IMigrationCallback
    {
    ...
    public static abstract class Stub extends android.os.Binder implements android.health.connect.aidl.IMigrationCallback
    {
         ...
         */
        public static android.health.connect.aidl.IMigrationCallback asInterface(android.os.IBinder obj)
        {
            if ((obj==null)) {
                return null;
            }
            android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (((iin!=null)&&(iin instanceof android.health.connect.aidl.IMigrationCallback))) {
                return ((android.health.connect.aidl.IMigrationCallback)iin);
            }
            return new android.health.connect.aidl.IMigrationCallback.Stub.Proxy(obj);
        }
        ...
        private static class Proxy implements android.health.connect.aidl.IMigrationCallback
        {
    ...
    public static final java.lang.String DESCRIPTOR = "android.health.connect.aidl.IMigrationCallback";
    // Called when the batch is successfully saved
