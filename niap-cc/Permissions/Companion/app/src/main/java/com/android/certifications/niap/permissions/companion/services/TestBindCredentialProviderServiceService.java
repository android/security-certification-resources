 ...
 */
public class TestBindCredentialProviderServiceService extends Service {
    private static final String TAG = "TestBindCredentialProviderServiceService";
    private TestBindCredentialProviderServiceServiceImpl bindService;

    @Override
    public void onCreate() {
        super.onCreate();
        bindService = new TestBindCredentialProviderServiceServiceImpl();
    }
    ...
    static class TestBindCredentialProviderServiceServiceImpl extends TestBindService.Stub {
        public void testMethod() {
            Log.d(TAG, "The caller successfully invoked the test method on service "
                    + "TestBindCredentialProviderServiceServiceService");
        }
    }
}